...
config_path = '/src/models/research/object_detection_tools/config/efficientdet_d0_coco17_tpu-32.config'
...
pipeline.train_config.fine_tune_checkpoint = '/src/pretrained_model/efficientdet_d0_coco17_tpu-32/checkpoint/ckpt-0'
